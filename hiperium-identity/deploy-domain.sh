...
vagrant ssh identity-node1 -c '$JBOSS_HOME/bin/standalone.sh -Djboss.server.base.dir=$JBOSS_HOME/standalone --server-config=standalone-ha.xml -b 172.16.76.3 -bmanagement=172.16.76.3 -Djboss.default.multicast.address=230.0.0.4 -Djboss.node.name=node1'
vagrant ssh identity-node2 -c '$JBOSS_HOME/bin/standalone.sh -Djboss.server.base.dir=$JBOSS_HOME/standalone --server-config=standalone-ha.xml -b 172.16.76.4 -bmanagement=172.16.76.4 -Djboss.default.multicast.address=230.0.0.4 -Djboss.node.name=node2'
